...
class MultipleChoiceViewController: UIViewController {
    ...
    func layoutView()
    {
        LayoutUtils.disableConstraints(view: contentView)
        view.addSubview(contentView)
        
        LayoutUtils.disableConstraints(view: questionView)
        view.addSubview(questionView)
        LayoutUtils.disableConstraints(view: questionLabel)
        ...
        LayoutUtils.disableConstraints(view: countdownView)
        ...
        answerView.leadingAnchor.constraint(equalTo: questionView.leadingAnchor, constant: 20.0),
        answerView.trailingAnchor.constraint(equalTo: questionView.trailingAnchor,constant: -20.0),
